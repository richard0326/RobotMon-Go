...
namespace ApiServer.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public async Task<LoginResponse> LoginPost(LoginRequest request)
        {
            ...
            // TODO Redis에 먼저 접근해서 AuthToken이 있는지 확인해야함. AuthToken이 이미 존재한다면 이미 로그인되어 있는 상황이다.
            ...
            if (string.IsNullOrWhiteSpace(password))
            {
                ...
                _logger.ZLogDebug($"LoginPost ErrorCode : {ErrorCode.Login_Fail_WrongPassword}");
                return response;
            }
            ...
            // TODO redis에 salt, AuthToken 값 저장
            //RedisDB.SetUserAuthToken(request.ID, hashingPassword);
